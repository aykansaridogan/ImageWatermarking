classdef logic < handle
    ...
    methods (Access = public)
        function initializeSource(this, SourceFile, type)
            ...
            % Giriş, svd için 2B matris olmalıdır.
            % Girdide alınan türü kontrol edin ve görüntüyü buna göre değiştirin
            % Gri tonlama için ayrıca görüntünün zaten olup olmadığını kontrol edin
            % Görüntü gri tonlamalıysa, R,G,B bileşen tipine izin vermeyin.
        ...
        function alteredWM = initializeWM(this, WMFile, type)
            ...
            % karıştırma için size(SourceImage) = size(WMImage)
            this.WMImage = imresize(alteredWM, this.Psize);
            
            % SourceImage ayarlanmışsa EmbedEnable'ı ayarlayın
